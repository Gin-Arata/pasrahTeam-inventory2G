...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/css/admin/adminBody.css">
    <!-- JS Fontawesome -->
    ...
    <div class="sidebar">
        <div class="sidebar-main mt-3">
            <a href="<?= BASEURL2 ?>/admin">
                <div class="sidebar-content"><img src="<?= BASEURL ?>/img/icon/home.png" alt="Home Logo" width="25"
                        height="25">
                    <p>Home</p>
                </div>
            </a>
        ...
        <div class="sidebar-footer">
            <a href="<?= BASEURL2 ?>/logout">
                <div class="sidebar-content"><img src="<?= BASEURL ?>/img/icon/logout.png" alt="Logout logo" width="25"
                        height="25">
                    <p>Logout</p>
                </div>
            </a>
