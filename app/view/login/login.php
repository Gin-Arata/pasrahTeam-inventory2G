    ...
    <div class=" container">
        ...
        <form action="<?= BASEURL2 ?>/login/prosesLogin" method="POST">
            ...
            <div class="form-group form-field">
                <input type="text" name="user_nim" class="form-control" id="NIP/NIM" placeholder="ex : 2241720000" required>
            </div>
            <label>PASSWORD</label>
            <div class="form-group form-field">
                <input type="password" name="user_pass" class="form-control" id="password" placeholder="ex : polinemajos!" required>
            </div>
            <div class="form-group form-field">
