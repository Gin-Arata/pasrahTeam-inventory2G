                ...
                <form action="" method="POST">
                    <div class="row">
                        <div class="input-group mb-3 d-flex align-items-center justify-content-left">
                            ...
                            <div class="col-md-4">
                                <input style="color: white; background-color: #838C96;" type="text" class="form-control input-set" id="NIP/NIM" value="<?= $_SESSION['userName'] ?>" disabled>
                            </div>
                            <!-- </div> -->
                        </div>
                        <div class="input-group mb-3 d-flex align-items-center justify-content-left">
                            ...
                            <div class="col-md-4">
                                <input style="color: white; background-color: #838C96;" type="text" class="form-control input-set" value="<?= $_SESSION['userNim'] ?>" id="NIP/NIM" disabled>
                            </div>
                        </div>
                        <div class="input-group mb-3 d-flex align-items-center justify-content-left">
                            <!-- <div class="row"> -->
