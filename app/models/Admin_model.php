...
class Admin_model
{
    ...
    {  
        if ($img['edit_gambar']['name'] != '') {
            ...
            $this->db->query("UPDATE $this->tableBarang SET nama_barang = :nama_barang, maintainer_barang = :maintainer_barang, jumlah_barang = :jumlah_barang, keterangan_barang = :keterangan_barang WHERE id_barang = :id_barang");
            $this->db->bind('id_barang', $data['id_barang']);
            $this->db->bind('nama_barang', htmlspecialchars($data['edit_nama']));
            $this->db->bind('maintainer_barang', htmlspecialchars($data['edit_maintain']));
            $this->db->bind('jumlah_barang', htmlspecialchars($data['edit_jumlah']));
